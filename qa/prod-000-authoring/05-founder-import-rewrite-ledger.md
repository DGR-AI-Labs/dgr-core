...
| `founder_approval_timeout.rs` | 8 | 10 | `989ae1df102c1a78638b28354e1cbcbd37e7cc3565292703840b2e7222f2c9b7` | `14cb21fbb11ac0a0216ae31150f292e9a9e1995ad332acf75b661116c8b6d0c2` | yes — R5.1 plus file-wide CRLF→LF normalization |
...
| Required active-test-name guard commit | `587585cf476431f078efe587c5dbcc052389cdad`; proves the named equality test remains present and active, not that its body is unchanged |
...
| R5.1 diff artifact/path | Raw: `qa/prod-000-review-evidence/r5-1-timeout.diff`; EOL-insensitive semantic hunk: `qa/prod-000-review-evidence/r5-1-timeout-semantic.diff` (SHA-256 `e5e5129dfd753112ddb71bbf2db207f172be55fb18636433fe99ca7c62a4d73d`) |
